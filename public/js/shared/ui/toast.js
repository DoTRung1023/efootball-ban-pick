/* ============================================================
   ...
   straight onto `#toast` and styled in `css/home/modals.css` and
   `css/signin.css`.

   The room page has its own `showToast` (a `toast--warn` variant on a 2.4 s
   timer, styled in `room.css`). The two are deliberately not merged: the class
